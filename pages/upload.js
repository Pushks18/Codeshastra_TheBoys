    ...
    <section class="text-gray-100 body-font w-full relative">
      <div class="container  p-10 py-20 bg-gray-800 flex sm:flex-nowrap flex-wrap justify-center">
        <div class=" w-full mx-32">
          ...
          <div class="relative mb-4">
            <label class="leading-7 text-2xl text-bold text-gray-100">
              Upload Thumbnail
            </label>
            <input
          ...
          <div class="relative mb-4">
            <label class="leading-7 text-2xl text-bold pt-5 mt-3 text-gray-100">
              Upload PDF
            </label>
            <input
              class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
          ...
          {(imageHash === "") | (pdfHash === "") | (certificateHash === "") ? (
            <button
              ...
              class="text-white bg-indigo-500 border-0 mt-2 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
              Upload
            </button>
          ) : (
